...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mDuration = a.getInt(R.styleable.AVLoadingIndicatorView_avlduration, mDuration);
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, Color.WHITE);
        setIndicator(mDefaultIndicator);
        mDefaultIndicator.setDuration(mDuration);
        a.recycle();
    }

    public BallPulseIndicator getIndicator(){
